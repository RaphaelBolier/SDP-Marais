...
const GameMenu = () => {
	...
	return (
		<Container className='text-center h-50 Home-container align-middle'>
			<Card>
				<CardHeader>
					<h1>Régles de Who did it?!</h1>
				</CardHeader>
				<CardBody className='text-left'>
					<h2>But du jeu </h2>
					<p> Le jeu est très simple : il y a des survivants, appelés  « Innocent »,
					...
					<ul>
						<li>
							<b>Missions : </b>
							<span>
								Au début de cette phase les joueurs apparaissent sur la carte et son libres de se déplacer librement, des "missions"
								sont attribuées aux innocents, l'objectif étant d'effectuer le plus de missions possibles.
								Les imposteurs devront alors se faire passer pour un joueur innocent tout en éliminant les différents innocents qu'il croisera.
							</span>
						</li>
						<li>
							<b>Interrogatoire : </b>
					...
					<ul>
						...
						<ul>
							...
							<li>
								Il ne peut effectuer des <b>Missions</b>.
							</li>
							<li>
								Il peut résoudre des <b>Urgences</b>.
							</li>
							<li>
								Il ne peut pas interragir avec certains des éléments de la carte (Raccourcis, cachette, porte...).
							</li>
						</ul>
					</ul>
					<h2>Missions :</h2>
						<p>Tâches que doivent effectuer les joueurs <b>Innocents</b>.</p>
						<p>Elles peuvent s'apprenter à des énigmes ou un enchainement d'actions simples.</p>
					<h2>Urgences :</h2>
